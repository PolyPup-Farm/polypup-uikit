...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React__default['default'].createElement("a", { target: "_blank", rel: "noreferrer", href: "https://rugdoc.io/project/polypup-finance/" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F2DA91", backgroundDisabled: "#dde6da", contrast: "#f7e9dc", invertedContrast: "#f1faee", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#221922", textDisabled: "#a4a9ab", textSubtle: "#221922", borderColor: "#8C342B", card: "#f7e9dc", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#221922", background: "#8C342B", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#191326", input: "#eeeaf4", primaryDark: "#F2DA91", tertiary: "#f7e9dc", text: "#221922", textDisabled: "#BDC2C4", textSubtle: "#221922", borderColor: "#524B63", card: "#F2DA91", gradients: {
